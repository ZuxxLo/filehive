...
class User(AbstractUser):
    ...
    is_verified = models.BooleanField(default=False) # to mark if the user has verified their email

#    is_active,first_name,last_name is provided by the AbstractUser class

    profilePicture = models.ImageField(upload_to=user_directory_path, blank=True) # don't forget to set the mdeia location
